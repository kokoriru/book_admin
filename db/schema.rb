...
ActiveRecord::Schema.define(version: 20160401065940) do
  ...
  add_index "book_authers", ["author_id"], name: "index_book_authers_on_author_id"
  add_index "book_authers", ["book_id"], name: "index_book_authers_on_book_id"
